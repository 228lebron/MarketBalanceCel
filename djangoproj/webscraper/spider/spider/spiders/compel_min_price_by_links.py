...
class CompelDetailSpider(scrapy.Spider):
    name = 'compel_min_price_by_links'
    ...
    def parse_product(self, response):
            ...
            for price_element in price_elements:
                if price_element is not None:
                    ...
                    if lowest_price is None or price < lowest_price:
                        ...
                        dt_text = offer.find('td', {'class': 'offer-header-dt'}).text.strip()
                        days_until_shipment = ''.join(filter(str.isdigit, dt_text))
        ...
        offer_item['days_until_shipment'] = days_until_shipment
